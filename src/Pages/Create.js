        ...
        <>
            {props.isLogined ?
                <div style={{ display: 'flex', flexDirection: 'column'}}>
                    <Typography variant='h4' component='div' gutterBottom sx={{my:3}}>Create New Item</Typography>
                    ...
                    <div>Name *</div>
                    <Input onChange={ (e)=>setInputs({...inputs,['name']: e.target.value})} sx={{mb:3}}></Input>
                    <div>External link</div>
                    <Input onChange={ (e)=>setInputs({...inputs,['externalLink']: e.target.value})} sx={{mb:3}}></Input>
                    <div>Description</div>
                    <Input onChange={ (e)=>setInputs({...inputs,['description']: e.target.value})} sx={{mb:3}}></Input>
                    <div>Collection</div>
                    <Input onChange={ (e)=>setInputs({...inputs,['collection']: e.target.value})} sx={{mb:3}}></Input>
                    <div style={{fontWeight:'bold', marginBottom:14}}>Attributes</div>
                    <div>trait_type</div>
                    <Input onChange={ (e)=>setInputs({...inputs,['trait_type']: e.target.value})} sx={{mb:3}}></Input>
                    <div>trait_value</div>
                    <Input onChange={ (e)=>setInputs({...inputs,['value']: e.target.value})} sx={{mb:3}}></Input>
                    <Button variant='contained' onClick={handleClickCreate} sx={{mb:2}}>Create</Button>                
                </div>
                : <Login />}
        </>
    )
